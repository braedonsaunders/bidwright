...
import { registerDrawingEvidenceTools } from "./tools/drawing-evidence-tools.js";
...
import { registerFileIngestTools } from "./tools/file-ingest-tools.js";
...
registerFileIngestTools(server);
