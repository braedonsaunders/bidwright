...
export function registerReviewTools(server: McpServer) {
    ...
    "Save competitiveness analysis — overestimates, underestimates, and productivity benchmarking data.",
    {
      ...
      benchmarking: z.object({
        ...
        streams: z.array(z.object({
          ...
          footage: z.number().optional().describe("Total footage/quantity"),
          hours: z.number().describe("Total quoted hours"),
          productionRate: z.number().optional().describe("Production rate (units/hr or ft/hr)"),
          unit: z.string().optional().describe("Unit of production rate (e.g. 'ft/hr')"),
          fmTlRatio: z.number().optional().describe("Foreman to Trade Labour ratio"),
  ...
  server.tool(
    ...
    {
      quoteTotal: z.number().describe("Total quoted amount"),
      worksheetCount: z.number().describe("Number of worksheets"),
      itemCount: z.number().describe("Total number of line items"),
      totalHours: z.number().optional().describe("Total labour hours"),
