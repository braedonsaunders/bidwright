/**
 * AgentLoop — server-side agent loop used by agent-routes and intake-routes.
 * The CLI runtime (cli-runtime.ts) is a separate path for Claude Code / Codex sessions.
 */
import type {
  AgentConfig,
  AgentResponse,
